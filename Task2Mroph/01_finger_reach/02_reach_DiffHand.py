...
'''
description:
DiffHand for finger reach task
'''
import os
import sys
...
if __name__ == '__main__':
    ...
    for i in range(task_num):
        ...
        task_point=[]        
        task_point.append(round(np.random.uniform(-5,25),3))
        task_point.append(round(np.random.uniform(-20,20),3))
        task_point.append(round(np.random.uniform(-5,20),3))
